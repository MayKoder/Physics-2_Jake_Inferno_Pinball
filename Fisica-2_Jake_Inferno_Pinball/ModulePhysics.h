...
public:
	...
	PhysBody* Create_Rectangle_Sensor(SDL_Rect rectangle, float rotation, SDL_Rect sec = { 0, 0, 0, 0 }, SDL_RendererFlip flip = SDL_FLIP_NONE, Animation* hit_animation = nullptr);
